...
class RouterConfig {
  ...
  */
  ...
  getModuleSwitch() {
    if (!this.module) {
      return this._getModuleSwitch().then((data) => {
        this.module = {};
        for (let key in data) {
  ...
  getPublicEncryptionKey() {
    if (!this.encryption.publicKey) {
      ...
      return Promise.resolve(this.encryption.publicKey);
    }
  }
